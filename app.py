...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///data.db') # Si esto corre en Heroku la variable "DATABASE_URL" la cogerá de sus variable. en caso contrario sigo usando "sqlite"   
